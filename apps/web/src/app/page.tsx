...
export default function Home() {
  return (
    <div>
      ...
      <section className="min-h-screen bg-gray-900 p-8 text-white">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mb-8 text-lg leading-relaxed md:text-xl">
            The effect is built with React Three Fiber and custom GLSL shaders,
            implementing advanced techniques like smooth minimum blending and 3D
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="text-gray-300">
                Uses distance fields to render complex 3D shapes efficiently in
                real-time.
              </p>
            </div>
            <div>
              <h3 className="mb-4 font-semibold text-xl">Metaball Blending</h3>
              <p className="text-gray-300">
            ...
            <div>
              <h3 className="mb-4 font-semibold text-xl">Interactive Trail</h3>
              <p className="text-gray-300">
